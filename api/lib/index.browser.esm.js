...
class Program {
    ...
    static getSubscription(connection, cb, commitment, filters) {
        return __awaiter(this, void 0, void 0, function* () {
            return connection.onProgramAccountChange(this.PUBKEY, ({ accountId, accountInfo }, context) => {
...
export { Account, ActionOnProve, ArweaveStorage, Auction, AuctionExtended, AuctionManager, AuctionManagerStatus, AuctionProgram, AuctionState, BidRedemptionTicket, BidStateType, BidderMetadata, BidderPot, ChainId, Coingecko, Connection, ConversionRateProvider, CreateAssociatedTokenAccount, CreateMint, Currency, DistributionType, ENV, Edition, EditionMarker, errors as Errors, MasterEdition, Metadata, MetadataKey, MetadataProgram, MetaplexKey, MetaplexProgram, NFTPacksAccountType, NFTPacksProgram, NonWinningConstraint, PackCard, PackSet, PackSetState, PackVoucher, PayForFiles, PayoutTicket, PriceFloorType, PrizeTrackingTicket, Program, ProvingProcess, SafetyDepositBox, SafetyDepositConfig, SetStore, Store, Transaction, index as Utils, Vault, VaultKey, VaultProgram, VaultState, WINNER_INDEX_OFFSETS, WhitelistedCreator, WinningConfigType, WinningConstraint };
